...
import { fetchWarehouseRetailerOrder } from "../../../../store/features/distributor";
...
const Orders = () => {
  ...
  const { warehouse, retailer } = useParams();
